...
<body>
    ...
    <h2 style="color:blue; text-align:center"><strong>About us</strong> </h2>
    <div class="alert alert-primary d-flex align-items-center" role="alert" style="text-align:center">
    </div>
    <div class="center">
    <img class="center" width="30%" height="20%" src="images/im7.jfif" alt="about us" ></img>
    </div>  
    </div>
    </header>
    <section>
      <div class="container">
        <p style="font-size:x-large;color:blue;">This website is created by VISHAL.MISHRA student of Atharva college of Engineering.The website deals with the basic banking system functionality.Here all the records of the customers of the bank can be viewed along with details like name,email,phoneno,balance,state,pincode.Any of the customer profile records can be viewed and can transfer money to other bank customers.The transaction records can also be viewed for each transaction.</p>
      </div>
    </section>
    <footer>
<div class="container">
