...
<body>
    ...
    <h2 style="color:blue; text-align:center"><strong>Contact us</strong> </h2>
    <div class="alert alert-primary d-flex align-items-center" role="alert" style="text-align:center">
    </div>
    ...
    <section>
      <div class="container">
        <div class="center">
          <img  class="center" src="images/im8.png" width="30%" height="20%" alt="contact us">
          <h1 class="alert alert-danger d-flex align-items-center">OUR CONTACT DETAILS</h1>
        </div>
</br>
     <div class="center">
       <h2 class="alert alert-success d-flex align-items-center">EMAIL:</h2>
       <h3>mcb@banking.in</h3>
       <h2 class="alert alert-success d-flex align-items-center">Phone number:</h2>
       <h3>+ 022 232 537 12</H3>
        <h3>+ 022 294 567 89</h3>
       <h2 class="alert alert-success d-flex align-items-center">Address</h2>
       <h3>Mumbai,India</h3>
     </div>
      </div>
    </section>
